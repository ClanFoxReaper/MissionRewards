...
namespace Missionrewards
{
	...
	public class MissionrewardsTacInstanceData
	{
	...
	/// </summary>
	public class MissionrewardsTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			MissionrewardsMain main = (MissionrewardsMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			MissionrewardsTacInstanceData data = (MissionrewardsTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new MissionrewardsTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
