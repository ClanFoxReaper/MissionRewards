...
namespace Missionrewards
{
	...
	public class MissionrewardsGSInstanceData
	{
	...
	/// </summary>
	public class MissionrewardsGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new MissionrewardsGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			MissionrewardsGSInstanceData data = (MissionrewardsGSInstanceData)instanceData;
		}
