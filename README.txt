...
- MissionrewardsConfig.cs: Example of ModConfig for custom mod settings;
- MissionrewardsGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- MissionrewardsMain.cs: Main mod class, recieves mod management and general events;
- MissionrewardsTactical.cs: Example of ModTactical for modifying tactical level;
